...
class AddUser extends Component {
    ...
    render() { 
        const {first_name, last_name, phone_number, email, handleChange, handleSubmit, title, submitDisabled, error, submitting} = this.props;
        ...
        right: '0px', zIndex: '100',top: '0px',
            ...
            <Grid style={{ padding: '5px 0px', borderRadius: '5px', width: '40%', background: '#F6F8FA', margin : '10% auto 0px auto'}}>
                ...
                <Grid style={{ 
                    ...
                    <TextField onChange={handleChange} value={first_name} name='first_name' style={{color: '#A2302F'}} placeholder='Fist Name'/>
